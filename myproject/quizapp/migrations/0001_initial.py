    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_attempt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quizapp.quizattempt')),
            ],
        ),
        migrations.CreateModel(
            name='QuizAnalytics',
            fields=[
                ...
                ('quiz_attempt', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='analytics', to='quizapp.quizattempt')),
            ],
        ),
        migrations.AddField(
            model_name='question',
